...
*/
  ...
  createVirtualBrowserClient({
    ...
    homeURL:"https://decentraland.org/places/"
  });

/*  createVirtualBrowserClient({
    colyseusServerURL:WEBSOCKET_URL,
    baseAPIURL:SERVER_BASE_URL,
    position:Vector3.create(11, 1.8, 8),
...
/*  createVirtualBrowserClient({
    ...
    rotation:Quaternion.fromEulerDegrees(0,180,0),
    scale:Vector3.create(3,768/1024 * 3,1),
    homeURL:"https://linktr.ee/fifitango",
    roomInstanceId:"fifitango-2"
  });*/
...
/*
  createVirtualBrowserClient({
    ...
    rotation:Quaternion.fromEulerDegrees(0,0,0),
    scale:Vector3.create(3,768/1024 * 3,1),
    homeURL:"https://decentraland.org/events/"
  });*/
